...
const en = {
  ...
  footerTagline: 'A multilingual smart travel guide for Khanh Hoi food street.', address: 'Khanh Hoi food street', rights: 'All rights reserved.',
  ...
  heroTitle: 'Explore Khanh Hoi with audio', heroText: 'Discover places, tours and narration in your preferred language.',
  ...
  geofenceAutoOn: 'Nearby place suggestions are on', geofenceAutoOff: 'Turn on nearby place suggestions', geofenceListening: 'Watching for nearby places by GPS...', geofenceDetected: 'Nearby place detected', geofenceAccessRequired: 'Nearby place needs a listening pass', geofencePlayPrompt: 'You are near this place. Do you want to play the audio narration?', geofenceAutoplayBlocked: 'The browser blocked automatic audio. Tap play once, then nearby places can continue automatically.', geofencePlaying: 'Playing nearby narration',
...
const vi: Messages = {
  ...
  footerTagline: 'Hệ thống hướng dẫn du lịch thông minh đa ngôn ngữ tại phố ẩm thực Khánh Hội.', address: 'Phố ẩm thực Khánh Hội', rights: 'Đã đăng ký bản quyền.',
  ...
  selectedLanguageAudio: 'Audio theo ngôn ngữ đã chọn', heroTitle: 'Khám phá Khánh Hội bằng audio', heroText: 'Khám phá địa điểm, tour và thuyết minh bằng ngôn ngữ bạn muốn.',
  ...
  geofenceAutoOn: 'Gợi ý địa điểm gần bạn đang bật', geofenceAutoOff: 'Bật gợi ý địa điểm gần bạn', geofenceListening: 'Đang dò địa điểm gần bạn qua GPS...', geofenceDetected: 'Phát hiện địa điểm gần bạn', geofenceAccessRequired: 'Địa điểm gần bạn cần gói nghe', geofencePlayPrompt: 'Bạn đang ở gần địa điểm này. Bạn có muốn phát audio thuyết minh không?', geofenceAutoplayBlocked: 'Trình duyệt đã chặn tự phát audio. Hãy bấm phát một lần, các địa điểm tiếp theo có thể tự phát.', geofencePlaying: 'Đang phát thuyết minh gần bạn',
...
const zh: Messages = {
  ...
  menu: '菜单', close: '关闭', explore: '探索', contact: '联系', footerTagline: 'Khanh Hoi 美食街多语言智能旅游指南。', address: 'Khanh Hoi 美食街', rights: '版权所有。',
  ...
  minutes: '分钟', stops: '站', startTour: '开始游览', route: '路线', selectedLanguageAudio: '所选语言的音频', heroTitle: '用语音探索 Khanh Hoi', heroText: '用您喜欢的语言探索景点、路线和讲解。',
...
const ko: Messages = {
  ...
  explore: '둘러보기', contact: '연락처', footerTagline: 'Khanh Hoi 음식 거리의 다국어 스마트 여행 가이드입니다.', address: 'Khanh Hoi 음식 거리', rights: '모든 권리 보유.',
  ...
  minutes: '분', stops: '정류장', startTour: '투어 시작', route: '경로', selectedLanguageAudio: '선택한 언어의 오디오', heroTitle: '오디오로 Khanh Hoi 탐험하기', heroText: '원하는 언어로 장소와 투어를 둘러보세요.',
...
const ja: Messages = {
  ...
  explore: '探索', contact: 'お問い合わせ', footerTagline: 'Khanh Hoi の多言語スマート観光ガイド。', address: 'Khanh Hoi', rights: '無断転載を禁じます。',
  ...
  minutes: '分', stops: 'スポット', startTour: 'ツアー開始', route: 'ルート', selectedLanguageAudio: '選択した言語の音声', heroTitle: '音声で Khanh Hoi を探索', heroText: 'お好みの言語でスポットやツアーを楽しめます。',
...
const fr: Messages = {
  ...
  menu: 'Menu', close: 'Fermer', explore: 'Explorer', contact: 'Contact', footerTagline: 'Guide touristique intelligent multilingue de Khanh Hoi.', address: 'Khanh Hoi', rights: 'Tous droits réservés.',
  ...
  minutes: 'minutes', stops: 'étapes', startTour: 'Démarrer le circuit', route: 'Itinéraire', selectedLanguageAudio: 'Audio dans la langue sélectionnée', heroTitle: 'Explorez Khanh Hoi en audio', heroText: 'Découvrez les lieux et circuits dans votre langue.',
...
export function I18nProvider({ lang, children }: { lang: Lang; children: ReactNode }) {
  ...
  const t = useCallback((key: MessageKey) => messages[lang][key] ?? en[key], [lang]);
