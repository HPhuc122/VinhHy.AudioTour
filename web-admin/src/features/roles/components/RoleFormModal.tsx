    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          <label className="text-sm font-medium text-[var(--app-heading)]">Mô tả</label>
          <textarea
            placeholder="Mô tả vai trò (tuỳ chọn)"
            rows={3}
            className="rounded-md border border-[var(--app-border)] px-3 py-2 text-sm text-[var(--app-heading)] focus:border-[var(--app-accent)] focus:outline-none focus:ring-2 focus:ring-[var(--app-accent-soft)]"
