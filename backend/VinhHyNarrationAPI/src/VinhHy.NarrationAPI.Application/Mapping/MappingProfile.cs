...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<CreatePoiRequest, Poi>()
            ...
            .ForMember(d => d.LifecycleStatus, opt => opt.Ignore())
            .ForMember(d => d.PaymentStatus, opt => opt.Ignore())
            .ForMember(d => d.ActivatedAt, opt => opt.Ignore())
            .ForMember(d => d.ValidFrom, opt => opt.Ignore())
            .ForMember(d => d.ValidUntil, opt => opt.Ignore())
            .ForMember(d => d.ActivatedByUserId, opt => opt.Ignore())
            .ForMember(d => d.ActivatedByUser, opt => opt.Ignore())
